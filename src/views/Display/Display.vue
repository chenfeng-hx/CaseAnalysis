...
let echartsPage = ref("casesClosed");
...
const choseEchartPage = val => {
	...
	if (val === "areaText") {
		...
		myChart.setOption(option);
		for (let i = startIndex.value; i < newArr.length - 1; ++i) {
			setTimeout(() => {
				const newOption = updateYear(newArr[i + 1], option);
				myChart.setOption(newOption);
			}, (i + 1) * updateFrequency.value);
		}
	}
}

const updateYear = (year, option) => {
						...
						<a @click="choseEchartPage('casesClosed')">
							<div class="single-process-item mb-50">
								...
								<div class="process-icon" :class="{ 'page-active': echartsPage === 'casesClosed' }">
									<img src="@/assets/images/law-book.png" alt="" />
								</div>
						...
						<a @click="choseEchartPage('specifiCrimes')">
							<div class="single-process-item mb-50">
								...
								<div class="process-icon" :class="{ 'page-active': echartsPage === 'specifiCrimes' }">
									<img src="@/assets/images/lawyer-2.png" alt="" />
								</div>
								<div class="process-content">
									<h5>案由比例</h5>
								</div>
						...
						<a @click="choseEchartPage('areaText')">
							<div class="single-process-item mb-50">
								...
								<div class="process-icon" :class="{ 'page-active': echartsPage === 'areaText' }">
									<img src="@/assets/images/podium-2.png" alt="" />
								</div>
								<div class="process-content">
									<h5>地区人口</h5>
								</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="single-blog-item">
							...
							<div class="blog-content">
								<h5>
									<a href="https://wenshu.court.gov.cn/website/wenshu/181029CR4M5A62CH/index.html" target="_blank">中国裁判文书网</a>
								</h5>
								<a href="https://wenshu.court.gov.cn/website/wenshu/181029CR4M5A62CH/index.html" target="_blank" class="read-more">了解更多</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="single-blog-item">
							...
							<div class="blog-content">
								<h5>
									<a href="http://gongbao.court.gov.cn/ArticleList.html?serial_no=sftj" target="_blank">中华人民共和国最高人民法院公报</a>
								</h5>
								<a href="http://gongbao.court.gov.cn/ArticleList.html?serial_no=sftj" target="_blank" class="read-more">了解更多</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="single-blog-item">
							...
							<div class="blog-content">
								<h5>
									<a href="http://www.court.gov.cn/fabu-gengduo-21.html?page=2" target="_blank">中华人民共和国最高人民法院</a>
								</h5>
								<a href="http://www.court.gov.cn/fabu-gengduo-21.html?page=2" target="_blank" class="read-more">了解更多</a>
							</div>
						</div>
					</div>
				</div>
