	...
	<div>
		...
		<div class="bottom" v-show="isShow">
			<div class="answer">
				...
				><span class="rightInfo">重庆市合川区人民法院</span>
						</li>
						<li>
                <span class="leftInfo">法院等级:</span
				><span class="rightInfo">基层人民政府</span>
						</li>
						<li>
                <span class="leftInfo">法院地区:</span
				><span class="rightInfo">合川区</span>
						</li>
						<li>
                <span class="leftInfo">案件类型:</span
				><span class="rightInfo">民事判决书</span>
						</li>
						<li>
                <span class="leftInfo">案件号:</span
				><span class="rightInfo">(2021)渝0117民初8466号</span>
						</li>
						<li>
                <span class="leftInfo">原告:</span
				><span class="rightInfo">张青军</span>
						</li>
						<li>
                <span class="leftInfo">被告:</span
				><span class="rightInfo">重庆建发置业有限公司</span>
						</li>
						<li>
                <span class="leftInfo">法条:</span
				><span class="rightInfo">自愿达成协议</span>
						</li>
					</ul>
				</div>
				<div class="area">
