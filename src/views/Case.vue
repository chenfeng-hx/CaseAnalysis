		...
		<div class="container" :class="{ containerActive: isShow9 }" v-loading="loading4"
			...
			<div :class="{ container3: isShow9 }">
				...
				<div class="cardBox" :class="{ putActive3: !isShow9 }">
					...
					<!--同案检索-->
					<div class="searchCard" @click="sameSearchBtn()"
				...
				<div class="right">
					...
					<div class="caseContainer">
						<div v-for="(item, index) in sameCase.slice(
							...
							<search-info v-if="hackReset" :currentPage2="(currentPage - 1) * pagesize + 1 + index"
								:caseArr2="item" :special="first"></search-info>
						</div>
					</div>
			...
			<el-main class="container2" v-show="!isShow9">
				<div v-if="iscase">
	              ...
	              ">
						...
						<!--todo:增加“高级人民法院”在这改-->
						<el-tag v-for="(tag1, index4) in courthierarchy" :key="index4 + 'd'" closable
							:disable-transitions="false" @close="handleClose(1, tag1)" style="margin: 0 8px">
							{{ tag1 }}
						</el-tag>
					...
					<div class="right" v-if="isShow">
						...
						<div class="caseContainer" v-if="hackReset2">
							<div v-for="(item, index) in caseArr.slice(
								...
								<search-info v-if="hackReset2" :currentPage2="(currentPage - 1) * pagesize + 1 + index"
									:caseArr2="item" :special="second"></search-info>
							</div>
						</div>
