	...
	<div class="topBar">
		<div class="topContent">
			...
			<div class="tab">
				...
				<div class="text" :class="{ 'tabs-active': appTab === 'analysis'}" @click="changTabName('analysis');">
					文书分析
				</div>
				<div class="text" :class="{ 'tabs-active': appTab === 'Case'}" @click="changTabName('Case')">案例库
				</div>
				<div class="text" :class="{ 'tabs-active': appTab === 'relevant'}" @click="changTabName('relevant')">
					相关科普
				</div>
				<div class="text" :class="{ 'tabs-active': appTab === 'display'}" @click="changTabName('display')">
					数据展示
				</div>
				<div class="text" :class="{ 'tabs-active': appTab === 'recommendation'}"
					 @click="changTabName('recommendation')">法条推荐
				</div>
			</div>
			<!--登录/注册-->
			<div class="frsmobi">
				<div class="signBtn">
					<el-button type="primary" @click="dialogVisible = true; flag = true" plain v-if="isShow18">
						注册/登录
					</el-button>
					<span v-if="!isShow18">你好！{{ username }} <span class="exit"
																	 @click="exitS()">退出登录</span></span>
				</div>
				<div class="mobitab">
					<div class="meun-icon" @click="ifshowtab()">
						<svg t="1680077174134" class="icon" viewBox="0 0 1024 1024" version="1.1"
